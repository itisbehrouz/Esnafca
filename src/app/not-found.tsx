...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-[#F2F2F7] flex flex-col items-center justify-center p-4 text-center">
      <div className="max-w-sm w-full bg-white rounded-3xl p-6 sm:p-8 border border-black/[0.06] shadow-sm space-y-4">
        ...
        <div className="pt-2">
          <Link
            href="/"
            className="w-full py-3 px-4 rounded-full bg-black text-white text-xs font-bold flex items-center justify-center gap-1.5 ios-press shadow-xs hover:bg-zinc-800"
          >
