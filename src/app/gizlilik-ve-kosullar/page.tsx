  ...
  return (
    <div className="min-h-screen bg-[#F2F2F7] dark:bg-black pb-24 text-black dark:text-white transition-colors duration-200">
      ...
      <div className="max-w-3xl mx-auto px-4 py-6 space-y-6">
        {/* Header Hero */}
        <div className="bg-white dark:bg-[#1C1C1E] rounded-ios-card p-5 sm:p-6 border border-black/[0.04] dark:border-white/[0.08] shadow-ios-card space-y-2">
          <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-blue-50 dark:bg-blue-950/60 text-blue-700 dark:text-blue-300 text-xs font-bold">
        ...
        <div className="bg-white dark:bg-[#1C1C1E] rounded-ios-card p-5 sm:p-6 border border-black/[0.04] dark:border-white/[0.08] shadow-sm space-y-3">
        ...
        <div className="bg-white dark:bg-[#1C1C1E] rounded-ios-card p-5 sm:p-6 border border-black/[0.04] dark:border-white/[0.08] shadow-sm space-y-3">
          ...
          <div className="space-y-2 text-xs text-zinc-600 dark:text-zinc-300 font-medium leading-relaxed">
            <p>
        ...
        <div className="bg-white dark:bg-[#1C1C1E] rounded-ios-card p-5 sm:p-6 border border-black/[0.04] dark:border-white/[0.08] shadow-sm space-y-3">
          ...
          <div className="pt-2">
            <a
              ...
              className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 text-black dark:text-white text-xs font-bold transition-all ios-press"
            >
